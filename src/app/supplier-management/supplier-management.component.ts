...
export class SupplierManagementComponent implements OnInit {
  ...
  addNewRow() { this.showNewRow = true; this.newRow = { supplier_name: '', phone: '', products_supplied: '' }; }
  ...
  startEdit(s: any) { this.editingId = s.supplier_id; this.editForm = { supplier_name: s.supplier_name, phone: s.phone, products_supplied: s.products_supplied }; }
